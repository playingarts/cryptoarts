...
export const deck: Omit<MongoDeck, "_id"> = {
  ...
  // ],
  labels: ["Contest", "AR-Enchanced", "Limited Edition"],
  slug,
...
export const cards = [
  ...
  },
  {
    ...
    suit: "clubs",
    artist: "gian-wong",
    info: "A century from now, human life could be struggling with extinction after fully exhausting earthâ€™s resources and neglecting its cry for help. The planet could simply not support life anymore. With this, humans will be left with only one solution: to evacuate and begin anew in another existing planet. The journey in finding a habitable home will be challenging but humans start to form a new appreciation for everything that exists beyond the earthâ€™s atmosphereâ€”and this time, mankind will vow to protect its new home.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-gian-wong.jpg",
    reversible: true,
  },
  {
    value: "2",
    ...
    info: "My illustration is an ironic vision of the future of music. Musical instruments will become electronic instruments for playing music. And musicians will be more like computer scientists.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/diego-marmolejo.gif",
    reversible: true,
  },
  {
    value: "3",
  ...
  },
  {
    ...
    info: "The idea of my illustration is an idealistic future world, where all existential problems of humanity are solved. A world where humans, nature and technology coexist peacefully and ecologically in perfect symbiosis.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-manuel-kilger.jpg",
  },
  {
    value: "4",
    edition: "chapter i",
    suit: "hearts",
    artist: "luis-pinto",
    info: "In the future humans learn that in order to evolve in a positive way theyâ€™ve to study a lot (even more) about the relationship between nature + technology as one to create a powerful impact on our planet. Thanks to this immense wisdom new generations are able to find sustainable-innovative solutions to coexist in this world as well as new scientific breakthroughs that will change the way we see, perceive and design our universe.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-luis-pinto.jpg",
  },
  {
    value: "4",
    edition: "chapter i",
  ...
  },
  {
    ...
    info: "When humanity disappears the world will change. Only robots will remain on the earth. They will start developing technologies and building civilization anew. Robots will enter into symbiosis with a peculiar post-apocalyptic nature. Therefore, my illustration depicts a robot that plays 8-bit games on old-fashioned computer.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/maria-kulinskaya.jpg",
  },
  {
    value: "5",
    edition: "chapter i",
    suit: "spades",
    artist: "antonio-uve",
    info: "The future will be tough if we keep treating the planet as we are, pollution will be an even bigger issue for us and a breeze of fresh air will be a luxury from the past. We tend to imagine the future in outer space but I think we will stuck here on Planet Earth wearing spacesuits for protection from air polluted, although with a touch of sophistication as I tried to illustrate here.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-antonio-uve.jpg",
  },
  {
    value: "5",
    edition: "chapter i",
  ...
  },
  {
    ...
    suit: "clubs",
    artist: "illustrescu",
    info: "Teleporting my imagination 100 years from now, I can see a fully developed society based on futuristic technologies. People are using more and more augmentations to stay updated and the crave for VR is tearing apart real society. Being dominated and governed by tech savy companies, the world as we know it today will not be the same, a new world will emerge.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/illustrescu.jpg",
    reversible: true,
  },
  {
    value: "5",
    ...
    info: "Inspired by what we are living now, the idea is that perhaps in the future, masks will not only be used as an instrument to keep us safe, to protect ourselves and the others, but it will evolve into an high-tech fashion accessory. Like are smartphones, or smartwatches today. Especially those last ones, that proved already in many occasions how a beautiful iconic piece of tech it's not only that, but it's also something that can prevent, detect and saves many lives. We took inspiration from futuristic fashion and thought that masks will become socially accepted in the future. An instrument that doesn't just scream 'I'm contagious', but that will be seen as 'fun', and 'social'. We imagined that it could work by tracking the movement of our mouth, to replicate that on the screen of the mask, which if swiped, shows different type of lips or filters. This way a futuristic mask will not just work to keep us safe, which will always be its primary function, but while doing that it will work also to make us smile. Litterally.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/amatita-studio.jpg",
    video:
  ...
  },
  {
    ...
    suit: "clubs",
    artist: "javier-perez",
    info: "In 100 years the wind energy will be normal as the electric light. It has become a key electricity generation resource for the transformation of the energetic model, cleaner and more sustainable.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-javier-perez.jpg",
  },
  {
    value: "6",
    edition: "chapter i",
    ...
    info: "In 100 years, as technology takes over even more, an optimistic thought is that humans will finally focus more on environment care, self improvement and love. The technology will enable also the option to send our characters as clones to achieve some challenges, while we are focused on others. ",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-andrea-bojkovska.jpg",
  },
  {
    value: "7",
    edition: "chapter i",
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-fran-labuschagne.jpg",
  },
  {
    value: "7",
    edition: "chapter i",
  ...
  },
  {
    ...
    suit: "clubs",
    artist: "pj-offner",
    info: "Its very obvious what the future would look like in 100 years. A world without technology or any form of economic structure. Humans are forced to become one with earth again. Snakes and humans fighting together for a better world.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-pj-offner.jpg",
    reversible: true,
  },
  {
    value: "7",
  ...
  },
  {
    ...
    suit: "spades",
    artist: "noonmoon",
    info: "In the distant future, sea level may have risen so high that even New Yorkâ€™s famous Statue of Libertyâ€™s head is barely above water.",
  ...
  },
  {
    ...
    suit: "hearts",
    artist: "peter-cobo",
    info: "I've been a big fan of science fiction since I was a kid. Maybe in 100 years, technology will have advanced enough to colonize other planets. Inspired by authors like Bradbury, Huxley or Orwell, I imagine humanity being able to travel light-years away to discover new planets and, who knows, new intelligent life as well. Because, 'If itâ€™s just us, seems like an awful waste of space'.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-peter-cobo.jpg",
  },
  {
    value: "8",
    edition: "chapter i",
    suit: "clubs",
    artist: "ryan-coleman",
    info: "Corporation MEGACORP knows you're tired of the same stale bottled and recycled air. Breathe new life into your day with FloraÂ® â€” the all-natural eco-approach to the oxygen generation. Featuring a sleek and efficient tank design as well as stylish Old Earth looking plants, you will have your own private oasis on the Space Train to the Cosmic Mines. Pre-order today to receive your complementary OxySpheresÂ® to add even more 'freshness' to your breathing experience.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/ryan-coleman.jpg",
  },
  {
    value: "8",
    edition: "chapter i",
  ...
  },
  {
    ...
    info: "I imagine a positive and hopeful world, where technology is in charge of taking care of the nature and the nature takes advantage of the technology. I imagine a world in a sustainable balance in terms of time, color, beauty and completely aware of the interdependecy principle.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-victor-vergara.jpg",
  },
  {
    value: "9",
    edition: "chapter i",
    ...
    info: "'Please don't forget to recharge your mask and update your heart before you leave your underground shelter'. The topic of the new deck is the future. I decided to make a romantic illustration showing preparations before going to a date.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-maria-fedoseeva.jpg",
  },
  {
    value: "9",
    edition: "chapter i",
  ...
  },
  {
    ...
    suit: "spades",
    artist: "muti",
    info: "Time travel has given the human race an opportunity to journey deeper into space than ever. The discovery on new planets has revealed many viable options for colonisation. ",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-muti.jpg",
  },
  {
    value: "10",
    edition: "chapter i",
    ...
    info: "As a huge fan of cyberpunk I wanted to express my current view of what's happening with the lockdown & traveling it to the future using biological engineered heart glowing underneath, creating a letter V that forms an X with the puddle's reflection which means 10 in roman numerals. As I see that it will be more challenging stuff in the future but the key is to support each other and seeking knowledge to be ahead of problems themselves.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/ilyas-bentaleb.jpg",
  },
  {
    value: "10",
    edition: "chapter i",
    ...
    info: "People living in the rhythm of a progressive 21st century often remember events of the past, where everything seemed to be simple and clear. While creating this illustration, I was inspired by the ideas of retrofuturism. I'm sure that in the future there will be muscle cars, rock-and-roll and minutes for fun too. I would like to see the future with optimism.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/alex-pogrebniak.jpg",
  },
  {
    value: "10",
    edition: "chapter i",
    suit: "diamonds",
    artist: "xave",
    info: "The future is a projection of our imagination since the moment you are reading this, it becomes the Present. Otherwise Robots and space fields.",
  ...
  },
  {
    ...
    info: "It is 2020 and we are at a crossroads. The decisions we now make as individuals and as societies will define the world a hundred years later. It will not be easy to make good and wise decisions to save our world. Perhaps the future lies in a simpler and poorer life, but in harmony with life-giving nature. Or maybe the future will lead us to the brink of extinction and nature will live only in our memories.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-aleksandra-marchocka.jpg",
    reversible: true,
  },
  {
    value: "queen",
  ...
  },
  {
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-marcelo-anache.jpg",
  },
  {
    value: "king",
    edition: "chapter i",
    ...
    info: "The image tells a story about a king that rules a kingdom inside his own head, as all of us do. For these endings he must find a balance between his heart and mind. The medieval castle is a critic against nowadays, as a suggestion that at the same time we are evolving on technology matters we are (many times) making the same old mistakes in history that our ancestors committed.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-luna-buschinelli.jpg",
  },
  {
    value: "king",
    edition: "chapter i",
    ...
    info: "I hope that in the future our leaders, our kings, will seek to discover our universe in harmony with nature and environment.",
  ...
  },
  {
    ...
    suit: "diamonds",
    artist: "raul-gil",
    info: "Diamonds in the French deck were generally linked to the economy and monarchy of the Middle Ages, being the card of the King of Diamonds someone powerful, rich and influential, king of kings and the economy at the same time. Who could play both roles in the future? Absolute sovereign of the economic functioning of the world. Ruler of all the invisible mechanisms that govern our society. Perhaps an artificial intelligence, raised as a higher entity? Always vigilant, always present, nothing escapes its control from its octahedral cubicle.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/raul-gil.jpg",
  },
  {
    value: "ace",
    edition: "chapter i",
  ...
  },
  {
    ...
    info: "Unfortunately, I assume that it will take so long before people change their approach to the exploitation of the land. Undoubtedly, many very expensive space projects will be created in the next 100 years. Even today we hear about plans to build the construction of bases on the Moon or the mission to populate Mars. But what about our Mother Earth? The current impact of Covid19 and quarantine reminds us of how much we need a healthy environment and a green, open space. Our land and its nature are the most important, we have nothing without it. I see Ace â™£ Clubs as a symbol of the power of nature and its value. It is our true wealth and this is our future.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/patrycja-krawczyk.jpg",
  },
  {
    value: "ace",
    edition: "chapter i",
  ...
  },
  {
    ...
    suit: "black",
    artist: "mitt-roshin",
    info: "I almost immediately came upon with this idea of a traditional for a card deck joker in the context of the future. In good old times Joker used to entertain a crowd on a square. But these days most of our entertainment take place online, in this digital reality, that is becoming even more real for us than everything that happens in the real life itself. So here is a joker form the future: not only heâ€™s entertaining us, but also manipulating, monitoring, setting up the rules, influencing all our actions, wishes, and emotions. Thatâ€™s how casually once a joker becomes a king.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-mitt-roshin.jpg",
  },
  {
    value: "backside",
    edition: "chapter i",
    ...
    info: "",
    img: "https://s3.amazonaws.com/img.playingarts.com/contest/retina/000.jpg?2",
  },
  {
    value: "joker",
    edition: "chapter i",
    suit: "black",
    artist: "adnan-ali",
    info: "Cast aside as a meaningless vessel, the joker has lost its influence as a purposeful asset. Treated as obscure and useless, it slowly died from the inside and rotted away. Ignored by the royalty and valued as nothing by the society, it suffered a fate it did not deserve. But times change and so does fate. The jokers will return one day, as an undead horde, to take back the reputation that was one theirs. The vessel that was once hollow now has a green spark. And the purpose that was once unknown, has now become vengeance!",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/adnan-ali.jpg",
  },
  {
    value: "joker",
    edition: "chapter i",
    ...
    info: "As if it were a science fiction story, what if the figure of the joker had transcended the icon and had become a key character in the cities of a dystopian future? An outsider. A kind of cyborg that mixes the classic outfit of a court minstrel with the most advanced technology in robotics",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-dani-blazquez.jpg",
  },
  {
    value: "2",
    edition: "chapter ii",
    suit: "spades",
    artist: "knysh-ksenya",
    info: "2 Spades Idea - Maybe one day we will find a portal to the future and we will have a chance to reach out and meet with someone who was on the other side ... The idea of using such a portal excites and intrigues me. Would you take a chance?",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/knysh-ksenya.jpg",
  },
  {
    value: "2",
    edition: "chapter ii",
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-meave-stvdivm.jpg",
    reversible: true,
  },
  {
    value: "2",
  ...
  },
  {
    ...
    suit: "hearts",
    artist: "pau-del-toro",
    info: "The future has to be emotional if we want to keep being humans. I cannot imagine a society with no emotions and robotized as it seems we go.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-pau-del-toro.jpg",
  },
  {
    value: "3",
    edition: "chapter ii",
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/hamed-sarhadi.jpg",
  },
  {
    value: "3",
    edition: "chapter ii",
    suit: "diamonds",
    artist: "lidan-chen",
    info: "Many species will be extinct in 2120. There are no wild animals anymore. Only robot creatures remain. Although the robots are friendly, but they will never replace real creatures.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-lidan-chen.jpg",
  },
  {
    value: "4",
    edition: "chapter ii",
    suit: "spades",
    artist: "silvan-borer",
    info: "I'm not sure how exactly the world will look like 100 years from now. But I'm sure it's still mother nature who stands above all. She's the source of all our inspirations.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/silvan-borer.jpg",
    reversible: true,
  },
  {
    value: "4",
  ...
  },
  {
    ...
    info: "I imagine a future world where technology has evolved to a point in which we put our lives in its hands and we mix with it, but nature keep claiming what belongs to her.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-andreu-zaragoza.jpg",
    reversible: true,
  },
  {
    value: "5",
    ...
    suit: "clubs",
    artist: "pilar-vega",
    info: "I propose a greener, ecological and environmentally friendly next century, where, after a great extinction of the largest animals that currently inhabit the planet, the surviving fauna and flora allies to subsist, evolving in a thousand ways, compared to a humanity lost in a new civilization.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/pilar-vega.jpg",
  },
  {
    value: "5",
    edition: "chapter ii",
    ...
    info: "Melancholy. Bad card, so they say. Always with those little 'thinghs' around, they whisper... It is dangerous for everyone to stand on the swing - You can't, you shouldn't. She was still there. Melancholy, 5th of Diamonds",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-stefano-ronchi.jpg",
  },
  {
    value: "6",
    edition: "chapter ii",
  ...
  },
  {
    ...
    info: "Food has always been a corner stone of human society. Cave men who went hunting, suddenly became farmers and so the rise of the cities has begone. Another big revolution in the food industry are the start of food delivery services. But in the future these human services will be at risk. Even though the transportation abilities will advance, the human aspect will be threatened by the rise of competitor delivery drones.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-robin-martens.jpg",
  },
  {
    value: "6",
    edition: "chapter ii",
  ...
  },
  {
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/nouran-zedan.jpg",
  },
  {
    value: "7",
    edition: "chapter ii",
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-jason-lyon.jpg",
    reversible: true,
  },
  {
    value: "7",
  ...
  },
  {
    ...
    suit: "diamonds",
    artist: "simon-buijs",
    info: "A stack of 7 elements, some of them are valuable and some are not. A stack that will never topple even when it's upside down thanks to the magic number 7.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-simon-buijs.jpg",
  },
  {
    value: "8",
    edition: "chapter ii",
  ...
  },
  {
    ...
    info: "LIVING IN THE AIR: In the not too distant future, humanity has felt the need to seek purer air and live above the clouds. The planet's contamination has reached extreme levels. The title of this work is practically a metaphor. existential related to a vital feeling and the search for new spaces to live.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/miguel-bencomo.jpg",
  },
  {
    value: "8",
    edition: "chapter ii",
    ...
    info: "No matter where you are or who you are, you can have world at your fingertips without leaving your comfort zone. Work from home, play from home, order food, talk to your family and friends, see the world - it's all there, in the comfort of your bubble.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/acrylic-pixie.jpg",
  },
  {
    value: "8",
    edition: "chapter ii",
  ...
  },
  {
    ...
    suit: "hearts",
    artist: "lena-vargas",
    info: "Many circumstances may change in 100 years, but one of the things I believe will stay the same is our need for escaping, feeling something more than the mere reality. Imagine if we could consume custom made capsules that would alter our conscious state to allow us to live dream-like experiences that would feel completely real and magical, although fleeting like any other substances. As simple as breathing fresh air, having an orgasmic encounter or flying in the sky. All would be possible with a scan of your DNA and technology., just as any other vending machine.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-lena-vargas.jpg",
  },
  {
    value: "9",
    edition: "chapter ii",
    ...
    info: "The new century will be marked by the end for a new beginning. Environmental pollution will give way to a new rebirth and nature will take back what belongs to it.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-gianluca-natale.jpg",
  },
  {
    value: "9",
    edition: "chapter ii",
    suit: "diamonds",
    artist: "burak-cinar",
    info: "In the future, some of our descendants will land on untouched planets and engineer ecosystems to maintain our fragile bodies. An ecosystem that is hard to recover in the heavily damaged pale blue dot.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/burak-cinar.jpg",
  },
  {
    value: "10",
    edition: "chapter ii",
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/martina-filippella.jpg",
  },
  {
    value: "10",
    edition: "chapter ii",
  ...
  },
  {
    ...
    info: "The future of new technologies, most part of which we can't even imagine right now, can be a bit scary sometimes, besides all the excitement, of course. This picture appeared in my mind one evening, probably inspired by my little son, peacefully sleeping after a rowdy day, and I decided to create a warm and cozy image of the future, no matter how weird it may turn up. After all, our future comes directly from our imagination, what can go wrong?",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-sofia-berlina.jpg",
  },
  {
    value: "10",
    edition: "chapter ii",
  ...
  },
  {
    ...
    suit: "diamonds",
    artist: "ben-bauchau",
    info: "When I think of Future, I think of robots, and I simply like the idea that this card game depicts a robot that has some sort of ritualistic or ceremonial costume, like the usual card figures use to have.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/ben-bauchau.jpg",
  },
  {
    value: "queen",
    edition: "chapter ii",
  ...
  },
  {
    ...
    info: "Iâ€™ve always been fascinated by the aesthetics surrounding the bionic future that apparently awaits mankind. I wanted to portrait a situation where the human side prevailed so I gave the main role to the heart necklace and gave it the subliminal appearance of having been extracted right out of the robotâ€™s chest.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/joaquin-rodriguez.jpg",
  },
  {
    value: "queen",
    edition: "chapter ii",
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-kaloian-toshev.jpg",
  },
  {
    value: "queen",
    edition: "chapter ii",
  ...
  },
  {
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-aleksey-rico.jpg",
  },
  {
    value: "ace",
    edition: "chapter ii",
    ...
    info: "For me in the future the history of humanity will come full circle. It will be only mother nature caring about what is left from earth.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-natalia-koniuszy.jpg",
  },
  {
    value: "ace",
    edition: "chapter ii",
  ...
  },
  {
    ...
    info: "In my opinion, how the future will look in 100 years is completely in our hands, it will depend on the wisdom and decisiveness of our actions, I am sure that the balance of life will be maintained. The only thing that will remain unchanged is the simple and main principle of nature, predator and prey.",
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/card-konstantin-shalev.jpg",
  },
  {
    value: "ace",
    edition: "chapter ii",
  ...
  },
  {
    ...
    img: "https://s3.amazonaws.com/img.playingarts.com/future/cards/shangning-wang.jpg",
  },
];
