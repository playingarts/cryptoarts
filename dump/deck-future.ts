...
export const cards = [
  ...
  },
  {
    ...
    suit: "spades",
    artist: "noonmoon",
    info: "In the distant future, sea level may have risen so high that even New York’s famous Statue of Liberty’s head is barely above water.",
