...
export const cards = [
  {
    ...
    info: "I wanted to create a surreal and conceptual illustration in a minimalist style. To me, 2 of clubs means two world- reality vs dream.",
    suit: "clubs",
    value: "2",
    deck: "one",
    opensea: "",
  ...
  {
    artist: "yema-yema",
    info: "My work is very playful and colorful. I try to base any character on basic shapes like circles or squares and work my way up. My main focus in character design, creatures that even though they look a bit scary at times, they are still approachable and fun. For this project I wanted to focus in my 2 of diamond concept but also include my style and some character design. I wanted a “solid dominant” shape and lots of little things to come out of him.",
    suit: "diamonds",
    value: "2",
    deck: "one",
    opensea: "",
  ...
  },
  {
    ...
    info: "I made the 2 of spades, the number two has always been my favorite number. I wanted to do a rather traditional playing card but I wanted to give the number two of spades some more tender love and care that the card usually get, being a low card.",
    suit: "spades",
    value: "2",
    deck: "one",
    opensea: "",
  ...
  },
  {
    ...
    info: "Using a familiar process whereby I let the materials dictate the piece – ’3 of Diamonds’ plays with the effects of optical distortion looking at glass or diamond as a metaphor for altered reality. The girl is lost within her distorted world, a world which is created and contained by her own thoughts.",
    suit: "diamonds",
    value: "3",
    deck: "one",
    opensea: "",
  ...
  },
  {
    ...
    info: "I choose 3 of hearts cause i really like this card (don´t ask me why). The idea was that it will be three hearts on the card, so i decided to draw a good one. The girl on the card is a good friend of mine.",
    suit: "hearts",
    value: "3",
    deck: "one",
    opensea: "",
  ...
  },
  {
    ...
    info: "I picked the Clubs card because it’s a symbol that’s close to nature. In some texts, they mention that Clubs can also mean flowers, clovers or crosses, and in the Tarot-universe, the symbol is associated to air. I like nature and birds a lot and I felt that it’s a little apt for the card.",
    suit: "clubs",
    value: "5",
    deck: "one",
    opensea: "",
  ...
  {
    artist: "aitch",
    info: "The 5 of hearts seems to me a very animated mix of symbolism, that s why i imagined it to be a vibrant scene of colourful beasts and flora.",
    suit: "hearts",
    value: "5",
    deck: "one",
    opensea: "",
  ...
  {
    artist: "musketon",
    info: "Jebus is equally awesome as Jesus but had a more rock and roll vibe to it. Jebus started out as a character of mine a year ago. I made 2 very detailed vector illustrations of him, now I’m sharing him with the rest of the world via this card.",
    suit: "spades",
    value: "5",
    deck: "one",
    opensea: "",
  ...
  },
  {
    ...
    info: "I’ve drawn a knight which holds and protects the six blades/swords which represent nobility.",
    suit: "spades",
    value: "6",
    deck: "one",
    opensea: "",
  ...
  {
    artist: "matt-w.-moore",
    info: "For the Seven-Of-Diamonds I chose to make a Diamond-Of-Sevens. It is somewhat of an ambigram since it reads the same when viewed from either perspective. It was fun to make the interlocking typography slightly cryptic yet still very legible upon closer inspection.",
    suit: "diamonds",
    value: "7",
    deck: "one",
    opensea: "",
  ...
  {
    artist: "pirecco",
    info: "The idea of my project was to work with an observation drawing and making a connection with the number of my card. So, I decided to draw my hands, where the sum of the fingers results in the number nine. To erase some parts of the drawing that I did not like, I used collage with craft paper.",
    suit: "diamonds",
    value: "9",
    deck: "one",
    opensea: "",
  ...
  },
  {
    ...
    info: "Queen of the club is showing the Equality of the two ladies that represent for the women’s strength. In my opinion, I want to present it as more illustration and more fashionable without loss of their old meaning.",
    suit: "clubs",
    value: "q",
    deck: "one",
    opensea: "",
  ...
  {
    artist: "conrad-roset",
    info: "I chose the Queen of hearts card because I thought that its the one that fits bettter with my style. Its very feminine, and I always like to draw female body and my muses.",
    suit: "hearts",
    value: "q",
    deck: "one",
    opensea: "",
  ...
  {
    artist: "james-white",
    info: "Being a kid of the 80s, I’m always fired up to do something with that rockin’ retro vibe. My King of Clubs is no different. I originally set out to do something character-based, but I quickly reverted to illustrating a more straight-forward approach… with the club symbol sporting a crown. I dove into some research material from the 80s era to properly capture the colour and aesthetic.",
    suit: "clubs",
    value: "k",
    deck: "one",
    opensea: "",
  ...
  {
    artist: "saturno",
    info: "Poker is a game where the details and wit are present, each person pretends to have something that basically does not have , and do not want other players to know who has, or otherwise. With this work what I understand , in this case, is that the monster could not impersonate authentic king , however great the crown, it is not a king, is a monster who only thinks about eating and drooling.",
    suit: "diamonds",
    value: "k",
    deck: "one",
    opensea: "",
  ...
  },
  {
    ...
    info: "I wanted to create a kind of ironic image of a king and I hope the audience will notice the little details that I incorporated into the artwork in order to achieve this. I really don’t want to be too descriptive here, I’m interested to know what people see in this work.",
    suit: "spades",
    value: "k",
    deck: "one",
    opensea: "",
  ...
  },
  {
    ...
    info: "The main idea was quite simple - to make something striking and eye-catching.",
    suit: "",
    value: "backside",
    deck: "one",
    opensea: "",
