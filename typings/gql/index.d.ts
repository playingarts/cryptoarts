...
interface QueryCardsByPathsArgs {
...
interface Mutation {
  ...
  updateProductCardGalleryPhotos?: Maybe<Product>;
}
...
interface MutationUpdateProductCardGalleryPhotosArgs {
  productId: Scalars['ID']['input'];
  cardGalleryPhotos: Array<Scalars['String']['input']>;
}
...
interface Product {
  ...
  cardGalleryPhotos?: Maybe<Array<Scalars['String']['output']>>;
  info?: Maybe<Scalars['String']['output']>;
  description?: Maybe<Scalars['String']['output']>;
  short: Scalars['String']['output'];
}
...
interface LastSale {
  ...
  nft_name: Scalars['String']['output'];
  nft_image: Scalars['String']['output'];
...
interface Opensea {
  ...
  average_price?: Maybe<Scalars['Float']['output']>;
  last_sale?: Maybe<LastSale>;
...
export type QueryResolvers<ContextType = { req: Request, res: Response }, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  cardsByPaths?: Resolver<Array<ResolversTypes['Card']>, ParentType, ContextType, RequireFields<QueryCardsByPathsArgs, 'paths'>>;
...
export type MutationResolvers<ContextType = { req: Request, res: Response }, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  updateProductCardGalleryPhotos?: Resolver<Maybe<ResolversTypes['Product']>, ParentType, ContextType, RequireFields<MutationUpdateProductCardGalleryPhotosArgs, 'productId' | 'cardGalleryPhotos'>>;
};
...
export type ProductResolvers<ContextType = { req: Request, res: Response }, ParentType extends ResolversParentTypes['Product'] = ResolversParentTypes['Product']> = {
  ...
  cardGalleryPhotos?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  info?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  short?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type LastSaleResolvers<ContextType = { req: Request, res: Response }, ParentType extends ResolversParentTypes['LastSale'] = ResolversParentTypes['LastSale']> = {
  ...
  nft_name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  nft_image?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type OpenseaResolvers<ContextType = { req: Request, res: Response }, ParentType extends ResolversParentTypes['Opensea'] = ResolversParentTypes['Opensea']> = {
  ...
  sales_count?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  average_price?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  last_sale?: Resolver<Maybe<ResolversTypes['LastSale']>, ParentType, ContextType>;
...
export type RatingResolvers<ContextType = { req: Request, res: Response }, ParentType extends ResolversParentTypes['Rating'] = ResolversParentTypes['Rating']> = {
  ...
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  deckSlugs?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
