...
export default {
  title: "old/Composed/CardBlock",
  component: ComposedCardBlock,
} as ComponentMeta<typeof ComposedCardBlock>;

const Template: ComponentStory<typeof ComposedCardBlock> = (args) => (
  <ComposedCardBlock
    css={(theme) => ({
