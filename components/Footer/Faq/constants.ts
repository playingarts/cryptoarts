...
export const FAQ_DATA = {
  ...
  "How much does it cost to ship a package?":
    "Shipping costs vary by location. We offer worldwide shipping with tracking. Standard shipping is $5-15 depending on your region, with free shipping available on orders over $45.",
  ...
  "What payment methods do you accept?":
    "We accept all major credit cards (Visa, Mastercard, American Express), PayPal, Apple Pay, and Google Pay. All transactions are securely processed.",
  "Do you offer refunds or exchanges?":
    "Yes, we offer a 30-day return policy for unopened items. If you receive a damaged product, contact us within 7 days for a replacement. See our full return policy for details.",
} as const;
