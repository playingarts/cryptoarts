...
const mockedClient = new ApolloClient({
  uri: "http://127.0.0.1/api/v1/graphql",
...
const meta = {
  title: "old/Header/ComposedHeader",
  tags: ["autodocs"],
  component: Component,
  decorators: (Story) => (
...
// export const Template: Meta<typeof Component> = {};
...
// const SecondTemplate: ComponentStory<typeof Component> = (args) => (
//   <Fragment>
//     <Component {...args} />
//     <div css={{ height: "200vh" }} />
//   </Fragment>
