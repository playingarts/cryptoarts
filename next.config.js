...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "img-src 'self' https://s3.amazonaws.com https://*.amazonaws.com https://www.google-analytics.com https://*.seadn.io https://openseauserdata.com data: blob:",
...
const nextConfig = {
  ...
  async headers() {
    return [
      ...
      {
        // Cache static pages at edge for better performance
        // ISR pages with revalidate will still work correctly
        source: "/",
        headers: [
          {
            key: "Cache-Control",
